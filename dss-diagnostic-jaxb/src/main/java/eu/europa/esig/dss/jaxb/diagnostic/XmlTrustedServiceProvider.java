 ...
 *         &lt;element name="TLInfo" type="{http://dss.esig.europa.eu/validation/diagnostic}TLInfo" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class XmlTrustedServiceProvider {
    ...
    @XmlElement(name = "TLInfo")
    protected XmlTLInfo tlInfo;
    ...
    /**
     * Gets the value of the tlInfo property.
     * 
     * @return
     *     possible object is
     *     {@link XmlTLInfo }
     *     
     */
    public XmlTLInfo getTLInfo() {
        return tlInfo;
    }

    /**
     * Sets the value of the tlInfo property.
     * 
     * @param value
     *     allowed object is
     *     {@link XmlTLInfo }
     *     
     */
    public void setTLInfo(XmlTLInfo value) {
        this.tlInfo = value;
    }
